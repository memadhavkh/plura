...
import { _getTicketsWithAllRelations, getFunnels, getMedia, getPipelineDetails, getTicketsWithTags, getUserPermissions } from "./queries";
import { z } from "zod";
import { db } from "./db";
...
export type AuthUserWithAgencySidebarOptionsSubAccounts = Prisma.PromiseReturnType<typeof getUserPermissions>;
